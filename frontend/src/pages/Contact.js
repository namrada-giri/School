...
export default function Contact() {
  ...
  const contactItems = [
    ['Address', 'Jorpati, Gokarneshwor-6, Kathmandu, Nepal'],
    ['Phone', '+977-1-xxxxxxxx'],
    ['Email', 'admissions@himalayanworldschool.com'],
    ['Website', 'www.himalayanworldschool.com'],
  ];
    ...
    <div className="form-page">
      <section className="form-hero">
        <div className="container">
          <span className="section-label">Contact Himalayan World School</span>
          <h1 className="section-title">Admissions, campus tours, and student enquiries.</h1>
          <p className="section-subtitle">
            Contact the school for admissions information, online registration, fees, academics, or student support. We're here to help guide your academic journey.
          </p>
        </div>
      </section>
          ...
          <div className="form-card">
            {status === 'success' ? (
              <div className="success-state">
                ...
                <h2>Message sent</h2>
                <p>Thank you for contacting Himalayan World School. The admissions office will respond soon.</p>
